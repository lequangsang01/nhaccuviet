                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                <div class="list-group-collapse sub-men">
                                    <a class="list-group-item list-group-item-action" href="#sub-men1" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">Piano <small class="text-muted">(100)</small>
								</a>
                                ...
                                <div class="list-group-collapse sub-men">
                                    <a class="list-group-item list-group-item-action" href="#sub-men2" data-toggle="collapse" aria-expanded="false" aria-controls="sub-men2">Guitar
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="Images2/piano/dan_piano_dien_roland_rp-30-400x400.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                ...
                                                <div class="why-text">
                                                    <a href="shop-detail.php"><h4>Roland RP-30( Mã SP : RP-30 )</h4></a>
                                                    <h5 style="color: red;"> <del style="color: black;">19.170.000đ</del> <br> 14.700.000đ</h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="shop-detail.php" data-toggle="tooltip" data-placement="right" title="Chi tiết sản phẩm"><i class="fas fa-eye"></i></a></li>
