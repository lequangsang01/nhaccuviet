...
<?php
	...
	class cart
	{
		...
		public function del_all_data_cart(){
			...
			$result = $this->db->delete($query);
			// if($result){
			// 	$msg =  echo '<script>alert("Thanh toán Thành công")</script>';
			// 	return $msg;
			// }
		}
		...
		public function get_inbox_cart_user($customer_id){
			$query = "SELECT * FROM tbl_order WHERE customer_id = '$customer_id' ORDER BY date_order";
			$get_inbox_cart = $this->db->select($query);
			return $get_inbox_cart;
		}
		public function shifted($id,$time,$price){
			...
			$result = $this->db->update($query);
			if($result){
				$msg = "<span class='success'>Câp nhật đơn hàng thành công</span>";
				return $msg;
			}else{
